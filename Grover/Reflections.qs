namespace Microsoft.Quantum.Samples.SimpleGrover {
    ...
    /// This operaion defines what input we are trying to find in the main
    /// search.
    operation ReflectAboutMarked(inputQubits : Qubit[]) : Unit {
        ...
        using (outputQubit = Qubit()) {
            within {
                ...
                // Here, we get the state alternating 0s and 1s by using
    ...
    operation ReflectAboutUniform(inputQubits : Qubit[]) : Unit {
        within {
            // Transform the uniform superpostion to all-zero.
